...
namespace K2Bridge.Visitors
{
    ...
    internal partial class ElasticSearchDSLVisitor : IVisitor
    {
        ...
        public void Visit(TermsAggregation termsAggregation)
        {
            ...
            termsAggregation.KustoQL = $"_data | {KustoQLOperators.Summarize} " + termsAggregation.SubAggregationsKustoQL + $"{termsAggregation.Metric} by {EncodeKustoField(termsAggregation.Key)} = {EncodeKustoField(termsAggregation)}";
