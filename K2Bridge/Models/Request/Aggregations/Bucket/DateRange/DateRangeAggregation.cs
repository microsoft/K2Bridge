...
namespace K2Bridge.Models.Request.Aggregations.Bucket.DateRange
{
    ...
    /// </summary>
    internal class DateRangeAggregation : BucketAggregation
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty("ranges")]
        public IList<DateRangeAggregationExpression> Ranges { get; set; }
