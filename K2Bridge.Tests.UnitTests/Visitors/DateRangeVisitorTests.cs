...
namespace UnitTests.K2Bridge.Visitors
{
    ...
    {
        [TestCase("2018-02-01", "2018-02-02", "2018-02-02", "2018-02-3", ExpectedResult = "_data | extend ['key'] = pack_array(strcat(make_datetime('2018-02-01'), '_', make_datetime('2018-02-02')),strcat(make_datetime('2018-02-02'), '_', make_datetime('2018-02-3'))), ['_range_value'] = pack_array(['dayOfWeek'] >= make_datetime('2018-02-01') and ['dayOfWeek'] < make_datetime('2018-02-02'),['dayOfWeek'] >= make_datetime('2018-02-02') and ['dayOfWeek'] < make_datetime('2018-02-3')) | mv-expand ['key'] to typeof(string), ['_range_value'] | where ['_range_value'] == true | summarize wibble by ['key'] | order by ['key'] asc | project-reorder ['key'], * asc")]
        [TestCase(null, "2018-02-02", "2018-02-02", "2018-02-3", ExpectedResult = "_data | extend ['key'] = pack_array(strcat('', '_', make_datetime('2018-02-02')),strcat(make_datetime('2018-02-02'), '_', make_datetime('2018-02-3'))), ['_range_value'] = pack_array(['dayOfWeek'] < make_datetime('2018-02-02'),['dayOfWeek'] >= make_datetime('2018-02-02') and ['dayOfWeek'] < make_datetime('2018-02-3')) | mv-expand ['key'] to typeof(string), ['_range_value'] | where ['_range_value'] == true | summarize wibble by ['key'] | order by ['key'] asc | project-reorder ['key'], * asc")]
        [TestCase("2018-02-01", "2018-02-02", "2018-02-02", null, ExpectedResult = "_data | extend ['key'] = pack_array(strcat(make_datetime('2018-02-01'), '_', make_datetime('2018-02-02')),strcat(make_datetime('2018-02-02'), '_', '')), ['_range_value'] = pack_array(['dayOfWeek'] >= make_datetime('2018-02-01') and ['dayOfWeek'] < make_datetime('2018-02-02'),['dayOfWeek'] >= make_datetime('2018-02-02')) | mv-expand ['key'] to typeof(string), ['_range_value'] | where ['_range_value'] == true | summarize wibble by ['key'] | order by ['key'] asc | project-reorder ['key'], * asc")]
        [TestCase(null, "2018-02-02", "2018-02-02", null, ExpectedResult = "_data | extend ['key'] = pack_array(strcat('', '_', make_datetime('2018-02-02')),strcat(make_datetime('2018-02-02'), '_', '')), ['_range_value'] = pack_array(['dayOfWeek'] < make_datetime('2018-02-02'),['dayOfWeek'] >= make_datetime('2018-02-02')) | mv-expand ['key'] to typeof(string), ['_range_value'] | where ['_range_value'] == true | summarize wibble by ['key'] | order by ['key'] asc | project-reorder ['key'], * asc")]
